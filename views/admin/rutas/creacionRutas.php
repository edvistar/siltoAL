...
<head>
    ...
    <!-- Google Fonts
		============================================ -->
    <link href="../../../public/https://fonts.googleapis.com/css?family=Play:400,700" rel="stylesheet">
    <!-- Bootstrap CSS
		============================================ -->
        ...
        <div class="left-sidebar-pro">
            <nav id="sidebar" class="">
                <div class="sidebar-header">
                    <a href="#"><img class="main-logo" src="../../../public/img/SILTO.png" alt="" /></a>
                    <strong><img src="../../../public/img/SILTO.png" alt="" /></strong>
                </div>
                <div class="left-custom-menu-adp-wrap comment-scrollbar">
                    <nav class="sidebar-nav left-sidebar-menu-pro">
                        <ul class="metismenu" id="menu1">
                            <li class="active">
                                <a class="has-arrow" href="views/creacionRutas.php">
                                       <i class="fa big-icon fa-users icon-wrap"></i>
                                       <span class="mini-click-non">Usuarios</span>
                                    </a>
                                <ul class="submenu-angle" aria-expanded="true">
                                    <li><a title="Registrar" href="<?php constant('URL');?>/rutas"><i class="fa fa-edit sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Registrar</span></a></li>
                                    <li><a title="Ver" href="ver-usuarios-admin.html"><i class="fa fa-eye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Ver</span></a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="logo-pro">
                            <a href="index.html"><img class="main-logo" src="../../../public/img/SILTO.png" alt="" /></a>
                        </div>
                    </div>
                </div>
            </div>
                                                ...
                                                <!--    <li class="nav-item dropdown">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                                ...
                                                                <img src="../../../public/img/contact/5.jpg" alt="">
                                                                <span class="admin-name">Yurly Yarlen Navia Guerrero</span>
                                                                <i class="fa fa-angle-down adminpro-icon adminpro-down-arrow"></i>
                                                            </a>
                                                      <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                            <!--<li><a href="admin/creacionRutas.php"><span class="fa fa-home author-log-ic"></span>Register</a>
                                                            </li>-->
                                                                            ...
                                                                            <ul class="notes-menu-list">
                                                                                <li>
                                                                                    <a href="#">
                                                                                        <div class="notes-list-flow">
                                                                                            <div class="notes-img">
                                                                                                <imgpublic/img/contact/4.jpg" alt="" />
                                                                                            </div>
                                                                                ...
                                                                                <li>
                                                                                    <a href="#">
                                                                                        <div class="notes-list-flow">
                                                                                            <div class="notes-img">
                                                                                                <imgpublic/img/contact/1.jpg" alt="" />
                                                                                            </div>
                                                                                            <div class="notes-content">
                                                                                                <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                                <span>Yesterday 2:45 pm</span>
                                                                                ...
                                                                                <li>
                                                                                    <a href="#">
                                                                                        <div class="notes-list-flow">
                                                                                            <div class="notes-img">
                                                                                                <imgpublic/img/contact/2.jpg" alt="" />
                                                                                            </div>
                                                                                            <div class="notes-content">
                                                                                                <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                                <span>Yesterday 2:45 pm</span>
                                                                                ...
                                                                                <li>
                                                                                    <a href="#">
                                                                                        <div class="notes-list-flow">
                                                                                            <div class="notes-img">
                                                                                                <imgpublic/img/contact/3.jpg" alt="" />
                                                                                            </div>
                                                                                            <div class="notes-content">
                                                                                                <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                                <span>Yesterday 2:45 pm</span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <ul class="breadcome-menu">
                                                <li><a href="#">Coordinadora</a> <span class="bread-slash">/</span>
                                                </li>
                                                <li><span class="bread-blod">Creacion de Rutas</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="text-center custom-login">
                            <h3>Creacion de Rutas</h3>
                        </div>
                        <div class="hpanel">
                            <div class="panel-body">
                                <form action="<?php echo constant('URL');?>/rutas/registrarRuta" method="POST" id="loginForm">
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            <label>Ruta Nº</label>
                                            <input type="number"  id="id_ruta" class="form-control" name="id_ruta">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label>destino</label>
                                            <input type="text" id="destino" class="form-control" name="destino" required>
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label>Fecha de salida Ruta</label>
                                            <input type="date"  id="fecha_ruta" class="form-control" name="fecha_ruta">
                                        </div>
                                        <div class="form-group col-lg-6">
                                        ...
                                        <div class="form-group col-lg-6">
                                           ...
                                           <select class="form-control" name="tipo_ruta"  id="tipo_ruta">
                                               <option value="1">Centro de Acopio</option>
                                               <option value="2">Aeropuerto</option>
                                               <option value="3">Supermecados</option>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" id="precinto" class="form-control" name="precinto">
                                        </div>
                                        <div class="form-group col-lg-6">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" id="id_centro" class="form-control" name="id_centro">
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="single-new-trend mg-t-30">
                                <a href="#"><imgpublic/img/new-product/5.jpg" alt=""></a>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="single-new-trend mg-t-30">
                                <a href="#"><imgpublic/img/new-product/6.jpg" alt=""></a>
                                <div class="overlay-content">
                                    <a href="#">
                                        <h2>$280</h2>
                                    </a>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="single-new-trend mg-t-30">
                                <a href="#"><imgpublic/img/new-product/7.jpg" alt=""></a>
                                <div class="overlay-content">
                                    <a href="#">
                                        <h2>$280</h2>
                                    </a>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="personal-info-wrap">
                                <div class="widget-head-info-box">
                                    ...
                                    <imgpublic/img/notification/5.jpg" class="img-circle circle-border m-b-md" alt="profile">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="author-widgets-single res-mg-t-30">
                                <div class="author-wiget-inner">
                                    <div class="perso-img">
                                        <imgpublic/img/notification/6.jpg" class="img-circle circle-border m-b-md" alt="profile">
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="personal-info-wrap personal-info-ano res-mg-t-30">
                                <div class="widget-head-info-box">
                                    ...
                                    <imgpublic/img/contact/2.jpg" class="img-circle circle-border m-b-md" alt="profile">
                                    <div class="social-widget-result">
                                        <span>100 Tweets</span> |
                                        <span>350 Following</span> |
                                        <span>610 Followers</span>
